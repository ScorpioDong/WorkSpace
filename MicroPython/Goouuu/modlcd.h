...
#define LCD_CS_1 gpio_set_level(CS_PIN, 1)
#define LCD_CS_0 gpio_set_level(CS_PIN, 0)

#define LCD_REST_1 gpio_set_level(RST_PIN, 1)
#define LCD_REST_0 gpio_set_level(RST_PIN, 0)

#define LCD_DC_1 gpio_set_level(RS_PIN, 1)
#define LCD_DC_0 gpio_set_level(RS_PIN, 0)

#define LCD_SDI_1 gpio_set_level(MOSI_PIN, 1)
#define LCD_SDI_0 gpio_set_level(MOSI_PIN, 0)

#define LCD_SCK_1 gpio_set_level(SCK_PIN, 1)
#define LCD_SCK_0 gpio_set_level(SCK_PIN, 0)

#define LCD_SDO gpio_get_level(MISO_PIN)

#define LCD_BL_1 gpio_set_level(LED_PIN, 1)
#define LCD_BL_0 gpio_set_level(LED_PIN, 0)
